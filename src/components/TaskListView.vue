...
<!-- <template>
    <div>
        <div class="flex items-center gap-5 px-150 py-4">
                <h1> Task List</h1>
                <router-link to = "/task/new" class="text-center "> <button class="bg-gray-700 px-3 py-1 rounded-md text-white cursor-pointer"> Add Task </button></router-link>
        </div>
      ...
      <select v-model="filterCategory" class="p-2 border rounded" data-testid="filter-category">
      ...
      <select v-model="sortBy" class="p-2 border rounded" data-testid="sort-by">
        ...
        <table class="w-full border-collapse border table-auto">
            ...
            <tbody v-if="filteredtasks.length > 0">
                <tr class="mt-4" v-for="task in filteredtasks" :key="task.id">
                    ...
                    <td class="border p-2"> 
                        <router-link :to="`/task/${task.id}`" class="mr-4"><button class="bg-gray-700 px-3 py-1 rounded-md text-white cursor-pointer">Edit</button></router-link>
                        <button @click="deleteTask(task.id)" class="bg-gray-700 px-3 py-1 rounded-md text-white cursor-pointer">Delete</button>
                    </td>
                </tr>
            </tbody>
            <tbody v-else>
